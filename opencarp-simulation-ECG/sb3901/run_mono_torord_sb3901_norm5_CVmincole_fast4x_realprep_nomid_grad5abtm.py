...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_mono_torord_sb3901_norm5_CVminchole_fast4x_realprep_nomid_grad5abtm',
...
def run(args, job):
    ...
    cmd += [
     ...
     '-prepacing_lats', os.path.join(args.inputdir, 'sb3901_meshes', 'init_acts_ACT_minchole4x-thresh.dat'),
    ]
# Aggiungi queste righe per chiedere a openCARP di calcolare i LAT
    ...
    cmd += [
        ...
        '-gregion[1].num_IDs', 1,
        '-gregion[1].ID[0]', 4,
        '-gregion[1].g_il', 0.2993 * 4.0,
        '-gregion[1].g_it', 0.1114 * 4.0, 
        '-gregion[1].g_in', 0.0601,
    ...
    cmd += [
        ...
        '-imp_region[1].im_param', 'flags=ENDO',
        ...
        '-adjustment[0].file', './sb3901_meshes/gks_tomek_gradient5abtm.adj',
        '-adjustment[0].dump', 1,
    ]
