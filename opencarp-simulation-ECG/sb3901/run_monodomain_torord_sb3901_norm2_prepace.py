...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='test_monodomain_torord_sb3901_norm2_prepace',
...
def run(args, job):
    ...
    cmd += [
        ...
        '-phie_recovery_file', 'sb3901_phie_recovery_norm2_prepace',
    ]
    ...
    '-prepacing_lats', './sb3901_meshes/sb3901_latmap_zero.dat',
    ]
