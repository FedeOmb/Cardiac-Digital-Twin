...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm2_prepace_fastendo_grad',
...
def run(args, job):
    ...
    cmd += [
       ...
       # '-pstrat', 1,
        ...
        '-phie_recovery_file', 'sb3901_phie_recovery_norm2_prepace_fastendo_grad',
    ]
   ...
   # cmd += [
    ...
    cmd += [
        ...
        '-imp_region[1].im_param', 'flags=MCELL,GKr_b*0.5',
        ...
        '-adjustment[0].file', './sb3901_meshes/gks_tomek_gradient2.adj',
        '-adjustment[0].dump', 1,
    ]
