...
def parser():
    ...
    parser.add_argument('--meshname',
                        default='./sb3901_meshes/sb3901_500um_tagged_fastendo',
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm2_prepace_fastendo',
...
def run(args, job):
    ...
    cmd += [
       ...
       # '-pstrat', 1,
        ...
        '-phie_recovery_file', 'sb3901_phie_recovery_norm2_prepace_fastendo',
    ]
