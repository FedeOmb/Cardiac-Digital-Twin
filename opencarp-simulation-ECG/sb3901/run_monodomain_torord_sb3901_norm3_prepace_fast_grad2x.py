...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm3_prep_fast_grad2x',
...
def run(args, job):
    ...
    cmd += [
       ...
       # '-pstrat', 1,
        ...
        '-phie_recovery_file', 'sb3901_phie_recovery_norm2_prep_fast_grad',
    ]
    ...
    cmd += [
        ...
        '-imp_region[0].im_param', 'flags=ENDO,GKr_b*1.3',
