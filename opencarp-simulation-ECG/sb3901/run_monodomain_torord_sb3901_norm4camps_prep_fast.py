...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm4camps_prep_fast',
...
def run(args, job):
    ...
    cmd += [
        ...
        '-imp_region[0].im_param', 'flags=ENDO,GKs_b*5,GKr_b*0.5,tjCa=60', #valori usati in framework camps
        ...
        '-imp_region[1].im_param', 'flags=EPI,GKs_b*5,GKr_b*0.5,tjCa=60',

        '-imp_region[2].name', 'Epicardio',
        '-imp_region[2].num_IDs', 1,
        '-imp_region[2].ID[0]', 1,      #tag epicardio 1
        '-imp_region[2].im', 'Tomek_editv3',
        '-imp_region[2].im_param', 'flags=EPI,GKs_b*5,GKr_b*0.5,tjCa=60',
        #'-num_adjustments', 1,   
