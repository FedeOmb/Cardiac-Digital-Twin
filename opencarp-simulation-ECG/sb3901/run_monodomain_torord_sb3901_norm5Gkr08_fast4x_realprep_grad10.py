...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm5Gkr08_fast4x_realprep_grad10',
...
# Aggiungi queste righe per chiedere a openCARP di calcolare i LAT
    ...
    cmd += [
        ...
        '-imp_region[0].im_param', 'flags=ENDO,GKr_b*0.8',
