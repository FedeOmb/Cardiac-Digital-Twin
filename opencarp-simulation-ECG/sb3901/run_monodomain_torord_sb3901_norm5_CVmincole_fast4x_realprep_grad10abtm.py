...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm5_CVminchole_fast4x_realprep_nomid_grad10abtm',
...
# Aggiungi queste righe per chiedere a openCARP di calcolare i LAT
    ...
    cmd += [
        ...
        '-adjustment[0].file', './sb3901_meshes/gks_tomek_gradient10abtm.adj',
        '-adjustment[0].dump', 1,
    ]
