...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='./test_monodomain_torord_sb3901_norm5_newCV_realprep_grad10',
...
# Aggiungi queste righe per chiedere a openCARP di calcolare i LAT
    ...
    cmd += [
        ...
        '-gregion[0].ID[1]', 2,
        '-gregion[0].ID[2]', 3,
        '-gregion[0].g_il', 0.3609, #unità misura S/m calibrati con tunecv per CV 0.65 m/s
        '-gregion[0].g_it', 0.2705, # calibrata  per CV 0.36 m/s
        '-gregion[0].g_in', 0.2368, # calibrata  per CV 0.48 m/s

        '-gregion[1].name', 'FastEndo',
        '-gregion[1].num_IDs', 1,
        '-gregion[1].ID[0]', 4,
        '-gregion[1].g_il', 0.3609 * 3.0,
        '-gregion[1].g_it', 0.2705 * 3.0, 
        '-gregion[1].g_in', 0.2368 * 3.0,
