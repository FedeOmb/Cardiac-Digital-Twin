...
def parser():
    ...
    parser.add_argument('--outdir',
                        default='test_monodomain_torord_sb4101_9rn_norm1_prepace',
...
def run(args, job):
    ...
    cmd += [
       ...
       # '-pstrat', 1,
        ...
        '-phie_recovery_file', 'sb4101_phie_recovery_9rn_norm1_prepace',
    ]
    cmd +=[
    '-prepacing_beats',   150,
