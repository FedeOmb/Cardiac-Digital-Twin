...
def parser():
    ...
    parser.add_argument('--times-file',
                        ...
                        help='File CSV contenente i tempi di attivazione (selected_root_nodes_times.csv)')
    parser.add_argument('--tend',
                        type=float, default=600.0,
                        help='Durata della simulazione in ms')
    parser.add_argument('--outdir',
                        default='test_monodomain_torord_sb4101_norm1_prepace_fastendo',
...
def run(args, job):
    ...
    cmd += [
        ...
        '-output_level', 5,
       # '-pstrat', 1,
        '-phie_rec_ptf', './sb4101_meshes/sb4101_electrodes_um',
        '-phie_recovery_file', 'sb4101_phie_recovery_norm1_prepace_fastendo',
    ]
    cmd +=[
    '-prepacing_beats',   150,
    ...
    '-prepacing_lats', './sb4101_meshes/sb4101_latmap_zero.dat',
    ]
