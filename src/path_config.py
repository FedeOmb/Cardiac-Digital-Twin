...
if __name__ == '__main__':
    ...
    path_mapping_json = '{"data_path":"/data/Cardiac-Digital-Twin/cardiac-data/meta_data/",' \
                        '"results_path":"/data/Cardiac-Digital-Twin/cardiac-data/meta_data/results_test/"}'
