...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        anatomy_subject_name = 'DTI004'# 'UKB_1002379'#'UKB_1000268' #'UKB_1000532'#'UKB_1000268' #'DTI004'  #'rodero_13' # 'rodero_13'  # 'DTI004'  # 'UKB_1000532' #'UKB_1000268'
        ecg_subject_name = 'DTI004'# 'UKB_1002379'#'UKB_1000268' #'UKB_1000532'#'UKB_1000268' #'DTI004'  # 'DTI004'  # 'UKB_1000532' # 'UKB_1000268'  # Allows using a different ECG for the personalisation than for the anatomy
