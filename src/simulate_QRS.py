...
if __name__ == '__main__':
    ...
    results_dir = path_dict["results_path"] + 'simulate_QRS_test/'
    # Output Paths:
    ...
    lv_candidate_root_node_meta_index, rv_candidate_root_node_meta_index = geometry.get_lv_rv_candidate_root_node_meta_index()
    ...
    conduction_system = DjikstraConductionSystemVC(
        ...
        lv_candidate_root_node_meta_index=lv_candidate_root_node_meta_index, rv_candidate_root_node_meta_index=rv_candidate_root_node_meta_index, purkinje_max_ab_cut_threshold=get_root_node_max_ab_cut_threshold(),
        vc_ab_cut_name=get_vc_ab_cut_name(), vc_rt_name=get_vc_rt_name(), verbose=verbose)
