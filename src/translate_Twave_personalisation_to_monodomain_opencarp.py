            ...
            for uncertainty_i in p1.range(uncertainty_parameter_population.shape[0]):
                ...
                if not os.path.exists(uncertainty_biomarker_result_file_name):
                    ...
                    for ionic_scaling_name in gradient_ion_channel_list:
                        adj_filename = uncertainty_biomarker_result_file_name.replace('.csv', f'_{ionic_scaling_name}.adj')
                        ...
                        p1.print(f'Saved openCARP .adj file for {ionic_scaling_name} at {adj_filename}')
                    ...
                    for field_col, field_suffix in fields_to_export:
                        dat_filename = uncertainty_biomarker_result_file_name.replace('.csv', f'_{field_suffix}.dat')
                    ...
                    ari_filename = uncertainty_biomarker_result_file_name.replace('.csv', '_ARI.dat')
