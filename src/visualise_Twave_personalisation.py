...
if __name__ == '__main__':
    ...
    from geometry_functions import EikonalGeometry, RawEmptyCardiacGeoTet, SimulationGeometry
    ...
    #assert os.path.exists(results_dir_part)  # Path should already exist from running the Twave inference
    print('results_dir_part: ', results_dir_part)
    ...
    print('results_dir_twave',results_dir_twave)
