...
void ToRORd_fkatp_endo_midIonType::tune(IonIfBase& iif_base, const char* im_par) const {
  IonIfDerived& iif = static_cast<IonIfDerived&>(iif_base);
  ToRORd_fkatp_endo_mid_Params *p;							// pointer to parameter structure
 ...
 */
void ToRORd_fkatp_endo_midIonType::print_params() const {
  IonIfDerived IF{*this, Target::AUTO, 0, {}};
  IF.initialize_params();
  printf("Name: ToRORd_fkatp_endo_mid\n" );
  printf("\tParameters:\n" );
...
int ToRORd_fkatp_endo_midIonType::write_svs(IonIfBase& IF_base, FILE *out, int node) const {
  IonIfDerived& IF = static_cast<IonIfDerived&>(IF_base);
  fprintf( out, "%s\n", IF.get_type().get_name().c_str() );

  int inner_id = node % this->dlo_vector_size();

  ToRORd_fkatp_endo_mid_state *sv = IF.sv_tab().data()+(node / (this->dlo_vector_size()));
...
int ToRORd_fkatp_endo_midIonType::read_svs(IonIfBase& IF_base, FILE *in) const {
  IonIfDerived& IF = static_cast<IonIfDerived&>(IF_base);
  ...
  ToRORd_fkatp_endo_mid_state *sv = IF.sv_tab().data();
...
SVgetfcn ToRORd_fkatp_endo_midIonType::get_sv_offset(const char *svname, int *off, int *sz) const {
  SVgetfcn retall = (SVgetfcn)(1);


        ToRORd_fkatp_endo_mid_state *sv;

        if( !strcmp(svname,"ALL_SV") )  {

          *off  = 0;

          *sz   = sizeof(ToRORd_fkatp_endo_mid_state);
        ...
        if( !strcmp(svname,"C1") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,C1);
        ...
        if( !strcmp(svname,"C2") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,C2);
        ...
        if( !strcmp(svname,"C3") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,C3);
        ...
        if( !strcmp(svname,"CaMKt") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,CaMKt);
        ...
        if( !strcmp(svname,"I") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,I);
        ...
        if( !strcmp(svname,"Jrel_np") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,Jrel_np);
        ...
        if( !strcmp(svname,"Jrel_p") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,Jrel_p);
        ...
        if( !strcmp(svname,"O") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,O);
        ...
        if( !strcmp(svname,"a") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,a);
        ...
        if( !strcmp(svname,"ap") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,ap);
        ...
        if( !strcmp(svname,"cai") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,cai);
        ...
        if( !strcmp(svname,"cajsr") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,cajsr);
        ...
        if( !strcmp(svname,"cansr") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,cansr);
        ...
        if( !strcmp(svname,"cass") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,cass);
        ...
        if( !strcmp(svname,"d") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,d);
        ...
        if( !strcmp(svname,"fcaf") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,fcaf);
        ...
        if( !strcmp(svname,"fcafp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,fcafp);
        ...
        if( !strcmp(svname,"fcas") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,fcas);
        ...
        if( !strcmp(svname,"ff") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,ff);
        ...
        if( !strcmp(svname,"ffp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,ffp);
        ...
        if( !strcmp(svname,"fs") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,fs);
        ...
        if( !strcmp(svname,"h") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,h);
        ...
        if( !strcmp(svname,"hL") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,hL);
        ...
        if( !strcmp(svname,"hLp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,hLp);
        ...
        if( !strcmp(svname,"hp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,hp);
        ...
        if( !strcmp(svname,"iF") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,iF);
        ...
        if( !strcmp(svname,"iFp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,iFp);
        ...
        if( !strcmp(svname,"iS") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,iS);
        ...
        if( !strcmp(svname,"iSp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,iSp);
        ...
        if( !strcmp(svname,"j") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,j);
        ...
        if( !strcmp(svname,"jca") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,jca);
        ...
        if( !strcmp(svname,"jp") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,jp);
        ...
        if( !strcmp(svname,"ki") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,ki);
        ...
        if( !strcmp(svname,"kss") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,kss);
        ...
        if( !strcmp(svname,"m") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,m);
        ...
        if( !strcmp(svname,"mL") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,mL);
        ...
        if( !strcmp(svname,"nai") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,nai);
        ...
        if( !strcmp(svname,"nass") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,nass);
        ...
        if( !strcmp(svname,"nca_i") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,nca_i);
        ...
        if( !strcmp(svname,"nca_ss") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,nca_ss);
        ...
        if( !strcmp(svname,"xs1") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,xs1);
        ...
        if( !strcmp(svname,"xs2") )  {
          ...
          *off  = offsetof(ToRORd_fkatp_endo_mid_state,xs2);
...
int ToRORd_fkatp_endo_midIonType::get_sv_list(char*** list) const {
...
#define BOGUSTYPE -1
int ToRORd_fkatp_endo_midIonType::get_sv_type(const char *svname, int *type, char **Typename) const
{
  *type = BOGUSTYPE;
  if (0) ;
...
void ToRORd_fkatp_endo_midIonType::print_metadata() const {
  printf("Metadata:\n");
  printf("\t\n");
  printf("\t\n");
  printf("\t\n");
...
extern "C" {
    limpet::ToRORd_fkatp_endo_midIonType* __new_IonType(bool plugin) {
              return new limpet::ToRORd_fkatp_endo_midIonType(plugin);
    }
}
