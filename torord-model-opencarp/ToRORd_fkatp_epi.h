...
#ifndef __TORORD_FKATP_EPI_H__
#define __TORORD_FKATP_EPI_H__
//// HEADER GUARD ///////////////////////////
...
#if !(defined(TORORD_FKATP_EPI_CPU_GENERATED)    || defined(TORORD_FKATP_EPI_MLIR_CPU_GENERATED)    || defined(TORORD_FKATP_EPI_MLIR_ROCM_GENERATED)    || defined(TORORD_FKATP_EPI_MLIR_CUDA_GENERATED))
#ifdef MLIR_CPU_GENERATED
#define TORORD_FKATP_EPI_MLIR_CPU_GENERATED
#endif

#ifdef MLIR_ROCM_GENERATED
#define TORORD_FKATP_EPI_MLIR_ROCM_GENERATED
#endif

#ifdef MLIR_CUDA_GENERATED
#define TORORD_FKATP_EPI_MLIR_CUDA_GENERATED
#endif
#endif

#ifdef CPU_GENERATED
#define TORORD_FKATP_EPI_CPU_GENERATED
#endif

namespace limpet {

#define ToRORd_fkatp_epi_REQDAT Vm_DATA_FLAG
#define ToRORd_fkatp_epi_MODDAT Iion_DATA_FLAG

struct ToRORd_fkatp_epi_Params {

};

struct ToRORd_fkatp_epi_state {
    GlobalData_t C1;
    GlobalData_t C2;
    GlobalData_t C3;
    GlobalData_t CaMKt;
    ...
    struct ToRORd_fkatp_epi_Regional_Constants_cpu {
                    
    char dummy;

    };

    struct ToRORd_fkatp_epi_Nodal_Req_cpu {
    
    GlobalData_t v;

    };

    struct ToRORd_fkatp_epi_Private_cpu {
      using nodal_req_type = ToRORd_fkatp_epi_Nodal_Req_cpu;
      using regional_constants_type = ToRORd_fkatp_epi_Regional_Constants_cpu;
      IonIfBase *IF;
      int   node_number;
      void* cvode_mem;
      void* sunctx_ptr;
...
void ToRORd_fkatp_epi_rosenbrock_f_cpu(float*, float*, void*);

void ToRORd_fkatp_epi_rosenbrock_jacobian_cpu(float**, float*, void*, int);
...
class ToRORd_fkatp_epiIonType : public IonType {
public:
    using IonIfDerived = IonIf<ToRORd_fkatp_epiIonType>;
    using params_type = ToRORd_fkatp_epi_Params;
    using state_type = ToRORd_fkatp_epi_state;

    using private_type = ToRORd_fkatp_epi_Private_cpu;
    #ifdef TORORD_FKATP_EPI_MLIR_CPU_GENERATED
    using private_type_vector = ToRORd_fkatp_epi_Private_mlir_cpu;
    #endif

    ToRORd_fkatp_epiIonType(bool plugin);
...
//void compute_ToRORd_fkatp_epi(int, int, IonIfBase&, GlobalData_t**);
#ifdef TORORD_FKATP_EPI_CPU_GENERATED
void compute_ToRORd_fkatp_epi_cpu(int, int, IonIfBase&, GlobalData_t**);
#endif
#ifdef TORORD_FKATP_EPI_MLIR_CPU_GENERATED
void compute_ToRORd_fkatp_epi_mlir_cpu(int, int, IonIfBase&, GlobalData_t**);
#endif
#ifdef TORORD_FKATP_EPI_MLIR_ROCM_GENERATED
void compute_ToRORd_fkatp_epi_mlir_gpu_rocm(int, int, IonIfBase&, GlobalData_t**);
#endif
#ifdef TORORD_FKATP_EPI_MLIR_CUDA_GENERATED
void compute_ToRORd_fkatp_epi_mlir_gpu_cuda(int, int, IonIfBase&, GlobalData_t**);
#endif
